...
<div>
  <v-main>
    <v-container>
      <KupediaLogo />
      <v-row class='justify-center' id='ku-wiki-is'>
        <div id='kuwiki-is'>
    ...
    <v-container>
      <v-row>
        <v-col cols='12'>
          ...
          <dl>
            <div>
              <dt>
                <v-icon>mdi-search-web</v-icon> サイト閲覧
              </dt>
              <dd>過去問やwikiを閲覧できます</dd>
            </div>
            <div>
              <dt>
                <v-icon>mdi-file-upload-outline</v-icon> 過去問提供
              </dt>
              <dd>一科目から提供できます．過去問をご覧になる方はご協力ください</dd>
            </div>
            <div>
              <dt>
            ...
            <div>
              <dt>
                <v-icon>mdi-code-json</v-icon> API利用
              </dt>
              <dd>開発者向けにAPIの利用方法を公開しています</dd>
            </div>
            <div>
              <dt>
                <v-icon>mdi-file-code-outline</v-icon> サイト開発
              </dt>
      ...
      <v-row>
        <v-col cols='12' sm='6'>
          <v-card outlined>
            ...
            <v-card-subtitle>
              全学で過去問を共有できます．
              すべての般教科目・専門科目の試験問題およびレポート課題を取り扱っています</v-card-subtitle>
            <v-card-text>
              <v-timeline align-top dense>
                <v-timeline-item small color='secondary'>
                  <h4>収集</h4>
                  <div>過去問を利用する方から集めています</div>
                  <ul>
                    <li>
                      📧 メール<nuxt-link to="/volunteer">こちら</nuxt-link>
                    </li>
                    <li>📂 学内回収ボックス/コロナで中断中</li>
                    <li>🖇 連携する自治会</li>
                  </ul>
                </v-timeline-item>
                ...
                <v-timeline-item small>
                  <h4>公開</h4>
                  <nuxt-link to="/courses">こちらのページ</nuxt-link> で公開中
                  ソースはこちら
                </v-timeline-item>
              </v-timeline>
            </v-card-text>
          ...
          <v-card outlined>
            ...
            <v-card-text>
              <v-timeline align-top dense>
                <v-timeline-item small color='secondary'>
                  <h4>記事作成</h4>
                  記事を書いたり，他webサイトのリンクを集めたりしています．順次拡張予定
                </v-timeline-item>
      ...
      <v-row>
        <v-col cols='12'>
          ...
          <div>
            <h4>活動経緯</h4>
            <h5>2014年</h5> ある学生が過去問を収集，過去問を見せた相手から問題を回収 <br />
            <h5>2018年</h5> 過去問をGoogleサイトでネット上に公開し過去問を募るように <br />
            <h5>2020年</h5> 各自治会との連携を開始，現サイトに移行して過去問の閲覧を京大生に限定<br />
          </div>
          <div>
            <h4>運営参加希望の方へ</h4>
...
h3:after {
  ...
  display: block;
  height: 4px;
  background: -webkit-linear-gradient(to right, var(--v-primary-base), transparent);
  background: linear-gradient(to right, var(--v-primary-base), var(--v-primary-base));
}
